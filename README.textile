...
3.  git remote add foundation git://github.com/handcrafted/foundation.git
4.  git pull foundation master
5.  git remote add origin git@github.com:me/my-foundation-app.git
6.  cp config/database.example.yml config/database.yml
7.  Confirm databse setup in config/database.yml
8.  rake gems:install
9.  rake db:create
10. rake db:migrate
11. rake db:seed